...
\begin{frame}{\pA{A3} — Hợp tác do disposition chi phối, bất biến qua ngôn ngữ}
  ...
  {\footnotesize\color{mute}Selfish 0\% (Qwen,Gemma) / 27\% (Llama) \;\textbullet\; risk-averse 73--93\% \;\textbullet\; \hl{5 ngôn ngữ đều $>$\eur120}; ô thấp nhất khác nhau theo model (Qwen/VI \eur140 · Gemma/AR \eur145 · Llama/ZH \eur141) $\Rightarrow$ ``yếu'' đặc thù-model, không phải thứ bậc ngôn ngữ}
\end{frame}
